webpackJsonp([0], {
  289: function(e, t, n) {
    ...
    var d = {
      ...
      f = (function(e) {
        function Editor() {
          ...
          return (e.handleChange = (0, s.default)(
    ...
    (f.propTypes = {
      code: o.PropTypes.string.isRequired,
    ...
    !(function(t, n) {
      ...
      function stretchSpansOverChange(e, t) {
        ...
        var i = t.from.ch,
          o = t.to.ch,
          a = 0 == cmp(t.from, t.to),
          l = markedSpansBefore(n, i, a),
          s = markedSpansAfter(r, o, a),
          c = 1 == t.text.length,
        ...
        if (l)
          for (var d = 0; d < l.length; ++d) {
            var p = l[d];
            if (null == p.to) {
              var f = getMarkedSpanFor(s, p.marker);
        ...
        if (s)
          for (var h = 0; h < s.length; ++h) {
            ...
            if ((null != g.to && (g.to += u), null == g.from)) {
              var m = getMarkedSpanFor(l, g.marker);
              m || ((g.from = u), c && (l || (l = [])).push(g));
            } else (g.from += u), c && (l || (l = [])).push(g);
          }
        l && (l = clearEmptySpans(l)), s && s != l && (s = clearEmptySpans(s));
        var v = [l];
        if (!c) {
          ...
          if (b > 0 && l)
            for (var x = 0; x < l.length; ++x)
              null == l[x].to &&
                (y || (y = [])).push(new MarkedSpan(l[x].marker, null, null));
          for (var C = 0; C < b; ++C)
            v.push(y);
          v.push(s);
        }
      ...
      function removeReadOnlyRanges(e, t, n) {
        ...
        for (
          ...
          ++o
            ...
            var c = i[s];
            if (!(cmp(c.to, l.from) < 0 || cmp(c.from, l.to) > 0)) {
              var u = [s, 1], d = cmp(c.from, l.from), p = cmp(c.to, l.to);
              (d < 0 || (!a.inclusiveLeft && !d)) &&
                u.push({ from: c.from, to: l.from }), (p > 0 ||
                (!a.inclusiveRight && !p)) &&
                u.push({ from: l.to, to: c.to }), i.splice.apply(i, u), (s +=
                u.length - 3);
            }
          }
        return i;
          ...
          for (var l = 0; l < a.length; ++l) {
            ...
            if (s.marker.collapsed) {
              var c = s.marker.find(0),
                u = cmp(c.from, n) || extraLeft(s.marker) - extraLeft(i),
                d = cmp(c.to, r) || extraRight(s.marker) - extraRight(i);
              if (
                !((u >= 0 && d <= 0) || (u <= 0 && d >= 0)) &&
                ((u <= 0 &&
          ...
          if (o) {
            ...
            if (l.level > 0) {
              ...
              (a = findFirst(
                ...
                a
              )), 'before' == c && (a = moveCharLogically(n, a, 1, !0));
      ...
      function moveVisually(e, t, n, r) {
        ...
        var l,
          ...
          c = function(n) {
            return e.options.lineWrapping
              ? ((l = l || prepareMeasureForLine(e, t)), wrappedLineExtentChar(
                  e,
                  t,
                  l,
                  n
        ...
        if ('rtl' == e.doc.direction || 1 == a.level) {
          var d = 1 == a.level == r < 0, p = s(n, d ? 1 : -1);
          if (
            null != p &&
        ...
        var h = function(e, t, r) {
          for (
            ...
            if (((c = l ? a.from : s(a.to, -1)), r.begin <= c && c < r.end))
              return o(c, l);
          }
        },
          g = h(o + r, r, u);
      ...
      function zeroWidthElement(e) {
        if (null == O) {
          ...
          removeChildrenAndAdd(
            ...
            (O = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(a && l < 8));
        }
        var n = O
          ? elt('span', '​')
          : elt(
      ...
      function highlightLine(e, t, n, r) {
        ...
        for (var a = 0; a < e.state.overlays.length; ++a) !(function(n) {
            var r = e.state.overlays[n], a = 1, l = 0;
            runMode(
              e,
              t.text,
              r.mode,
              ...
              function(e, t) {
                for (var n = a; l < e; ) {
                  var o = i[a];
                  o > e &&
                    i.splice(a, 1, e, i[a + 1], o), (a += 2), (l = Math.min(
                    e,
                    o
                  ));
                }
      ...
      function getStateBefore(e, t, n) {
        ...
        return (a = a
          ...
          (n.stateAfter = l ? copyState(r.mode, a) : null), ++o;
        }), n && (r.frontier = o), a;
      }
      ...
      function takeToken(e, t, n, r) {
        ...
        ) (d.start = d.pos), (i = readToken(l, d, u)), r && s.push(o(!0));
        return r ? s : o();
      }
        ...
        for (
          ...
          if (
            (d.pos > e.options.maxHighlightLength
              ? ((l = !1), a && processLine(e, t, r, d.pos), (d.pos =
                  t.length), (s = null))
              : (s = extractLineClasses(readToken(n, d, r, p), o)), p)
          ) {
            var f = p[0].name;
            f && (s = 'm-' + (s ? f + ' ' + s : f));
          }
      ...
      function findStartLine(e, t, n) {
        for (
          ...
          var c = countColumn(s.text, null, e.options.tabSize);
      ...
      function buildLineContent(e, t) {
        var n = eltP('span', null, null, s ? 'padding-right: .1px' : null),
          r = {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
          ...
          (r.pos = 0), (r.addToken = buildToken), hasBadBidiRects(e.display.measure) && (l = getOrder(o, e.doc.direction)) && (r.addToken = buildTokenBadBidi(r.addToken, l)), (r.map = []);
          insertLineContent(
            o,
            r,
      ...
      function buildToken(e, t, n, r, i, o, s) {
        if (t) {
          var c,
              ...
              if ('\t' == h[0]) {
                ...
                '\r' == h[0] || '\n' == h[0]
                  ...
                  : ((v = e.cm.options.specialCharPlaceholder(
                      h[0]
                    )), v.setAttribute('cm-text', h[0]), a && l < 9
      ...
      function insertLineContent(e, t, n) {
        ...
        if (r)
          for (
            var a, l, s, c, u, d, p, f = i.length, h = 0, g = 1, m = '', v = 0;
            ;

          ) {
            if (v == h) {
              (s = c = u = d = l = ''), (p = null), (v = 1 / 0);
      ...
      function ensureLineWrapped(e) {
        return e.node == e.text &&
          ((e.node = elt('div', null, null, 'position: relative')), e.text
            ...
            e.text
          ), a && l < 8 && (e.node.style.zIndex = 2)), e.node;
      }
      ...
      function updateLineGutter(e, t, n, r) {
        ...
        if (e.options.lineNumbers || o) {
          ...
          if (
            (e.display.input.setUneditable(l), a.insertBefore(l, t.text), t.line
              .gutterClass && (l.className += ' ' + t.line.gutterClass), !e
              .options.lineNumbers ||
      ...
      function insertLineWidgetsFor(e, t, n, r, i) {
        if (t.widgets)
          for (
            var o = ensureLineWrapped(n), a = 0, l = t.widgets;
            a < l.length;
            ++a
          ) {
            var s = l[a], c = elt('div', [s.node], 'CodeMirror-linewidget');
            s.handleMouseEvents ||
              ...
              n,
              r
            ), e.display.input.setUneditable(c), i && s.above
              ? o.insertBefore(c, n.gutter || n.text)
              : o.appendChild(c), signalLater(s, 'redraw');
          }
      }
      ...
      function nodeAndOffsetInLineMap(e, t, n) {
        for (var r, i, o, a, l, s, c = 0; c < e.length; c += 3) if (
            ((l = e[c]), (s = e[c + 1]), t < l
              ? ((i = 0), (o = 1), (a = 'left'))
              : t < s
                  ? ((i = t - l), (o = i + 1))
        ...
        if (3 == s.nodeType) {
          for (var p = 0; p < 4; p++) {
            ...
            for (
              ...
              ++u;
            if (
              ((i = a && l < 9 && 0 == c && u == o.coverEnd - o.coverStart
                ? s.parentNode.getBoundingClientRect()
                : getUsefulRect(w(s, c, u).getClientRects(), r)), i.left ||
                i.right ||
                0 == c)
            )
              break;
          ...
          a && l < 11 && (i = maybeUpdateRectForZooming(e.display.measure, i));
        } else {
          c > 0 && (d = r = 'right');
          var f;
          i = e.options.lineWrapping && (f = s.getClientRects()).length > 1
      ...
      function intoCoordSystem(e, t, n, r, i) {
        ...
        if ('line' == r) return n;
        r || (r = 'local');
        var l = heightAtLine(t);
        if (
          ('local' == r
            ? (l += paddingTop(e.display))
            : (l -= e.display.viewOffset), 'page' == r || 'window' == r)
        ) {
          var s = e.display.lineSpace.getBoundingClientRect();
          l += s.top + ('window' == r ? 0 : pageScrollY());
          var c = s.left + ('window' == r ? 0 : pageScrollX());
          (n.left += c), (n.right += c);
        }
      ...
      function cursorCoords(e, t, n, r, i, o) {
        function get(t, a) {
          var l = measureCharPrepared(e, i, t, a ? 'right' : 'left', o);
          return a
            ? (l.left = l.right)
            : (l.right = l.left), intoCoordSystem(e, r, l, n);
        }
        ...
        var a = getOrder(r, e.doc.direction), l = t.ch, s = t.sticky;
        if (
          (l >= r.text.length
            ? ((l = r.text.length), (s = 'before'))
            : l <= 0 && ((l = 0), (s = 'after')), !a)
        )
          return get('before' == s ? l - 1 : l, 'before' == s);
        var c = getBidiPartAt(a, l, s), u = R, d = getBidi(l, c, 'before' == s);
        return null != u && (d.other = getBidi(l, u, 'before' != s)), d;
      }
      ...
      function coordsChar(e, t, n) {
        ...
        for (var a = getLine(r, i); ; ) {
          var l = coordsCharInner(e, a, i, t, n),
            s = collapsedSpanAtEnd(a),
            c = s && s.find(0, !0);
      ...
      function coordsCharInner(e, t, n, r, i) {
        i -= heightAtLine(t);
        var o, a = 0, l = t.text.length, s = prepareMeasureForLine(e, t);
        if (getOrder(t, e.doc.direction)) {
          if (e.options.lineWrapping) {
            var c;
            (c = wrappedLineExtent(e, t, s, i)), (a = c.begin), (l = c.end);
          }
          o = new Pos(n, a);
          var u,
            d,
            p = cursorCoords(e, o, 'line', t, s).left,
            f = p < r ? 1 : -1,
            h = p - r;
          do {
            if (
              ((u = h), (d = o), null == (o = moveVisually(e, t, o, f)) ||
                o.ch < a ||
                l <= ('before' == o.sticky ? o.ch - 1 : o.ch))
            ) {
              o = d;
              break;
            }
            h = cursorCoords(e, o, 'line', t, s).left - r;
        ...
        var m = cursorCoords(e, o, 'line', t, s);
      ...
      function posFromMouse(e, t, n, r) {
        ...
        var s, c = coordsChar(e, o, a);
        if (
          r &&
          1 == c.xRel &&
          (s = getLine(e.doc, c.line).text).length == c.ch
        ) {
          var u = countColumn(s, s.length, e.options.tabSize) - s.length;
          c = Pos(
            c.line,
            Math.max(
              0,
          ...
          a++
            ...
            if (
              ...
              (s || e.options.showCursorWhenSelecting) &&
                drawSelectionCursor(e, l.head, i), s ||
                drawSelectionRange(e, l, o);
            }
          }
        return r;
      }
      ...
      function drawSelectionRange(e, t, n) {
        ...
        function drawForLine(t, n, r) {
          ...
          return iterateBidiSections(
            ...
            function(e, t, i) {
              ...
              null == n && 0 == e && (d = l), c.top - f.top > 3 &&
                (add(d, f.top, null, f.bottom), (d = l), f.bottom < c.top &&
                ...
                (a = c), d < l + 1 && (d = l), add(d, c.top, p - d, c.bottom);
            }
          ), { start: o, end: a };
        }
        var r = e.display,
        ...
        if (c.line == u.line) drawForLine(c.line, c.ch, u.ch);
          ...
          f &&
            ...
            g.top && add(l, h.bottom, null, g.top);
        }
        n.appendChild(o);
      }
      ...
      function setScrollTop(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 ||
          ((e.doc.scrollTop = t), n || updateDisplaySimple(e, { top: t }), e
            .display.scroller.scrollTop != t &&
            (e.display.scroller.scrollTop = t), e.display.scrollbars.setScrollTop(
            t
          ), n && updateDisplaySimple(e), startWorker(e, 100));
      }
      function setScrollLeft(e, t, n) {
        (n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) ||
          ((t = Math.min(
            t,
            e.display.scroller.scrollWidth - e.display.scroller.clientWidth
          )), (e.doc.scrollLeft = t), alignHorizontally(e), e.display.scroller
            .scrollLeft != t &&
        ...
        if ((i && c) || (o && u)) {
          ...
          if (i && !n && !d && null != le)
            return o &&
              ...
              Math.max(
                0,
                Math.min(l.scrollLeft + i * le, l.scrollWidth - l.clientWidth)
              )
            ), (!o || (o && u)) &&
              e_preventDefault(t), void (a.wheelStartX = null);
          if (o && null != le) {
            var g = o * le, m = e.doc.scrollTop, v = m + a.wrapper.clientHeight;
            g < 0
              ? (m = Math.max(0, m + g - 50))
              : (v = Math.min(
                  e.doc.height,
          ...
          ae < 20 &&
            (null == a.wheelStartX
              ? ((a.wheelStartX = l.scrollLeft), (a.wheelStartY =
                  l.scrollTop), (a.wheelDX = i), (a.wheelDY = o), setTimeout(
                  function() {
      ...
      function initScrollbars(e) {
        e.display.scrollbars &&
          (e.display.scrollbars.clear(), e.display.scrollbars.addClass &&
            ...
            )), (e.display.scrollbars = new ue[e.options.scrollbarStyle](
          function(t) {
          ...
          function(t, n) {
            'horizontal' == n ? setScrollLeft(e, t) : setScrollTop(e, t);
          },
          e
      ...
      function scrollPosIntoView(e, t, n, r) {
        ...
        for (var i, o = 0; o < 5; o++) {
          ...
          if (
            (null != c.scrollTop &&
              (setScrollTop(e, c.scrollTop), Math.abs(e.doc.scrollTop - u) >
      ...
      function calculateScrollPos(e, t) {
        ...
        var l = e.doc.height + paddingVert(n),
          s = t.top < r,
          c = t.bottom > l - r;
      ...
      function addToScrollPos(e, t, n) {
        (null == t && null == n) ||
          resolveScrollToPos(
            e
          ), null != t && (e.curOp.scrollLeft = (null == e.curOp.scrollLeft ? e.doc.scrollLeft : e.curOp.scrollLeft) + t), null != n && (e.curOp.scrollTop = (null == e.curOp.scrollTop ? e.doc.scrollTop : e.curOp.scrollTop) + n);
      }
      ...
      function endOperation_R1(e) {
        ...
        maybeClipScrollbars(
          t
        ), e.updateMaxLine && findMaxLine(t), (e.mustUpdate = e.viewChanged || e.forceUpdate || null != e.scrollTop || (e.scrollToPos && (e.scrollToPos.from.line < n.viewFrom || e.scrollToPos.to.line >= n.viewTo)) || (n.maxLineChanged && t.options.lineWrapping)), (e.update = e.mustUpdate && new pe(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
      }
      ...
      function endOperation_finish(e) {
        ...
        if (
          (e.updatedDisplay && postUpdateDisplay(t, e.update), null ==
            ...
            )), n.scrollbars.setScrollTop(r.scrollTop), (n.scroller.scrollTop =
              r.scrollTop)), null == e.scrollLeft ||
            ...
            )), n.scrollbars.setScrollLeft(
              r.scrollLeft
            ), (n.scroller.scrollLeft = r.scrollLeft), alignHorizontally(
              t
            )), e.scrollToPos)
        ) {
          maybeScrollWindow(
        ...
        if (o)
          for (var l = 0; l < o.length; ++l)
            o[l].lines.length && signal(o[l], 'unhide');
      ...
      function regChange(e, t, n, r) {
        ...
        if (
          ...
          var l = viewCuttingPoint(e, t, t, -1),
            s = viewCuttingPoint(e, n, n + r, 1);
          l && s
            ? ((i.view = i.view
                .slice(0, l.index)
                .concat(buildViewArray(e, l.lineN, s.lineN))
                .concat(i.view.slice(s.index))), (i.viewTo += r))
            : resetView(e);
        }
            ...
            function(o) {
              if (t.frontier >= e.display.viewFrom) {
                var a = o.styles,
                  ...
                  s = highlightLine(e, o, l ? copyState(t.mode, r) : r, !0);
                o.styles = s.styles;
                ...
                for (
                  ...
                  d = a[p] != o.styles[p];
                d && i.push(t.frontier), (o.stateAfter = l
                  ? r
                  : copyState(t.mode, r));
              } else
      ...
      function patchDisplay(e, t, n) {
        function rm(t) {
          var n = t.nextSibling;
          return s && y && e.display.currentWheelTarget == t
      ...
      function normalizeSelection(e, t) {
        ...
        for (var r = 1; r < e.length; r++) {
          ...
          if (cmp(o.to(), i.from()) >= 0) {
            ...
            r <= t && --t, e.splice(--r, 2, new he(s ? l : a, s ? a : l));
          }
        }
        return new fe(e, t);
      }
      ...
      function computeReplacedSel(e, t, n) {
        for (var r = [], i = Pos(e.first, 0), o = i, a = 0; a < t.length; a++) {
          var l = t[a],
            s = offsetPos(l.from, i, o),
            c = offsetPos(changeEnd(l), i, o);
          if (((i = l.to), (o = c), 'around' == n)) {
            var u = e.sel.ranges[a], d = cmp(u.head, u.anchor) < 0;
            r[a] = new he(d ? c : s, d ? s : c);
          } else r[a] = new he(s, s);
        }
      ...
      function updateDoc(e, t, n, r) {
        ...
        if (t.full)
          ...
          update(s, s.text, u), d && e.remove(i.line, d), p.length &&
            e.insert(i.line, p);
        } else if (l == s)
          if (1 == a.length)
            update(l, l.text.slice(0, i.ch) + c + l.text.slice(o.ch), u);
          else {
            var f = linesFor(1, a.length - 1);
            f.push(new Q(c + l.text.slice(o.ch), u, r)), update(
              l,
              l.text.slice(0, i.ch) + a[0],
              spansFor(0)
            ), e.insert(i.line + 1, f);
          }
        else if (1 == a.length)
          update(
            l,
            l.text.slice(0, i.ch) + a[0] + s.text.slice(o.ch),
            spansFor(0)
          ), e.remove(i.line + 1, d);
        else {
          update(l, l.text.slice(0, i.ch) + a[0], spansFor(0)), update(
            s,
            c + s.text.slice(o.ch),
            u
          );
        ...
        function propagate(e, r, i) {
          if (e.linked)
            for (var o = 0; o < e.linked.length; ++o) {
              var a = e.linked[o];
              if (a.doc != r) {
                var l = i && a.sharedHist;
                (n && !l) || (t(a.doc, l), propagate(a.doc, e, l));
              }
            }
        }
        propagate(e, null, !0);
      ...
      function addChangeToHistory(e, t, n, r) {
        ...
        if (
          ...
          var s = lst(i.done);
          for (
            (s && s.ranges) || pushSelectionToHistory(e.sel, i.done), (o = {
        ...
        i.done.push(
          n
        ), (i.generation = ++i.maxGeneration), (i.lastModTime = i.lastSelTime = l), (i.lastOp = i.lastSelOp = r), (i.lastOrigin = i.lastSelOrigin = t.origin), a || signal(e, 'historyAdded');
      }
      ...
      function reCheckSelection(e) {
        setSelectionInner(e, skipAtomicInSelection(e, e.sel, null, !1), D);
      }
      function skipAtomicInSelection(e, t, n, r) {
        for (var i, o = 0; o < t.ranges.length; o++) {
          var a = t.ranges[o],
            l = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o],
            s = skipAtomic(e, a.anchor, l && l.anchor, n, r),
            c = skipAtomic(e, a.head, l && l.head, n, r);
          (i || s != a.anchor || c != a.head) &&
            (i || (i = t.ranges.slice(0, o)), (i[o] = new he(s, c)));
        }
        ...
        if (o.markedSpans)
          for (var a = 0; a < o.markedSpans.length; ++a) {
            ...
            if (
              ...
              if (i && (signal(s, 'beforeCursorEnter'), s.explicitlyCleared)) {
                if (o.markedSpans) {
                  --a;
                  continue;
                }
              ...
              return (r < 0 ? s.inclusiveLeft : s.inclusiveRight) &&
        ...
        if (!e.cm || !e.cm.state.suppressEdits || n) {
          ...
          if (s != a.length) {
            for (
              ...
              if ((pushSelectionToHistory(r, l), n && !r.equals(e.sel)))
            ...
            for (
              ...
              var p = (function(n) {
                ...
                linkedDocs(e, function(e, t) {
                  t ||
                    -1 != indexOf(l, e.history) ||
                    (rebaseHist(e.history, i), l.push(
                      e.history
      ...
      function makeChangeSingleDocInEditor(e, t, n) {
        ...
        e.options.lineWrapping ||
          ((s = lineNo(visualLine(getLine(r, o.line)))), r.iter(
            s,
            a.line + 1,
            function(e) {
          ...
          if (o.ranges) {
            ...
            for (var l = 0; l < o.ranges.length; l++)
              rebaseHistSelSingle(
                ...
                n,
                r
              ), rebaseHistSelSingle(o.ranges[l].head, t, n, r);
          } else {
        ...
        return o &&
          ...
          if (
            ...
            updateLineHeight(t, t.height + widgetHeight(i)), r &&
              addToScrollPos(o, null, i.height), (o.curOp.forceUpdate = !0);
          }
          return !0;
        }), signalLater(
          o,
        ...
        if (
          (e.iter(s, n.line + 1, function(e) {
            c &&
              ...
              (l = !0), o.collapsed && s != t.line && updateLineHeight(e, 0), addMarkedSpan(e, new MarkedSpan(o, s == t.line ? t.ch : null, s == n.line ? n.ch : null)), ++s;
          }), o.collapsed &&
      ...
      function markTextShared(e, t, n, r, i) {
        ...
        var o = [markText(e, t, n, r, i)], a = o[0], l = r.widgetNode;
        return linkedDocs(e, function(e) {
          l &&
            (r.widgetNode = l.cloneNode(
              !0
      ...
      function copySharedMarkers(e, t) {
        for (var n = 0; n < t.length; n++) {
          var r = t[n],
            ...
            a = e.clipPos(i.to);
          if (cmp(o, a)) {
            var l = markText(e, o, a, r.primary, r.primary.type);
                  ...
                  if (
                    ...
                    (a.onload = operation(t, function() {
                      ...
                      if (
                        ...
                        makeChange(t.doc, s), setSelectionReplaceHistory(
                          t.doc,
                          simpleSelection(n, changeEnd(s))
                        );
                      }
                    })), a.readAsText(e);
                  }
      ...
      function doHandleBinding(e, t, n) {
        ...
        try {
          e.isReadOnly() &&
            (e.state.suppressEdits = !0), n && (e.display.shift = !1), (i = t(e) != N);
        } finally {
          ...
          if (!clickInGutter(t, e)) {
            ...
            switch ((window.focus(), e_button(e))) {
              case 1:
                ...
                break;
              case 2:
                s && (t.state.lastMiddleDown = +new Date()), r &&
      ...
      function leftButtonDown(e, t, n) {
        ...
        Ne && Ne.time > i - 400 && 0 == cmp(Ne.pos, n)
          ...
          : Ae && Ae.time > i - 400 && 0 == cmp(Ae.pos, n)
              ? ((r = 'double'), (Ne = { time: i, pos: n }))
              : ((r = 'single'), (Ae = { time: i, pos: n }));
        ...
        e.options.dragDrop &&
          ...
          'single' == r &&
          (o = l.contains(n)) > -1 &&
          (cmp((o = l.ranges[o]).from(), n) < 0 || n.xRel > 0) &&
          (cmp(o.to(), n) > 0 || n.xRel < 0)
          ? leftButtonStartDrag(e, t, n, s)
          : leftButtonSelect(e, t, n, r, s);
      }
      function leftButtonStartDrag(e, t, n, r) {
        var i = e.display,
          o = +new Date(),
          c = operation(e, function(u) {
            s &&
              (i.scroller.draggable = !1), (e.state.draggingText = !1), off(document, 'mouseup', c), off(i.scroller, 'drop', c), Math.abs(
              t.clientX - u.clientX
            ) +
              Math.abs(t.clientY - u.clientY) <
              10 &&
              (e_preventDefault(u), !r &&
                +new Date() - 200 < o &&
                extendSelection(e.doc, n), s || (a && 9 == l)
                ? setTimeout(function() {
        ...
        s &&
          (i.scroller.draggable = !0), (e.state.draggingText = c), (c.copy = y ? t.altKey : t.ctrlKey), i.scroller.dragDrop && i.scroller.dragDrop(), G(document, 'mouseup', c), G(i.scroller, 'drop', c);
      }
      function leftButtonSelect(e, t, n, r, i) {
          ...
          if (0 != cmp(f, t))
            if (((f = t), 'rect' == r)) {
              ...
              i.length ||
                ...
                a,
                normalizeSelection(c.ranges.slice(0, s).concat(i), s),
                { origin: '*mouse', scroll: !1 }
              ), e.scrollIntoView(t);
            } else {
              var b = l, x = b.anchor, C = t;
              if ('single' != r) {
                var w;
                (w = 'double' == r
                  ? e.findWordAt(t)
              ...
              (S[s] = new he(clipPos(a, x), C)), setSelection(
                a,
          ...
          if (i)
            if (0 != cmp(i, f)) {
              ...
              s &&
                setTimeout(
                  operation(e, function() {
                    g == n && ((o.scroller.scrollTop += s), extend(t));
                  }),
                  50
                );
            }
        ...
        e_preventDefault(t);
        var l, s, c = a.sel, u = c.ranges;
        if (
          (i && !t.shiftKey
            ? ((s = a.sel.contains(n)), (l = s > -1 ? u[s] : new he(n, n)))
            : ((l = a.sel.primary()), (s = a.sel.primIndex)), b
            ? t.shiftKey && t.metaKey
            : t.altKey)
        )
          (r = 'rect'), i || (l = new he(n, n)), (n = posFromMouse(
            e,
            t,
            !0,
            !0
          ...
          l = e.display.shift || a.extend
            ? extendRange(a, l, d.anchor, d.head)
            : d;
        } else if ('triple' == r) {
          var p = new he(Pos(n.line, 0), clipPos(a, Pos(n.line + 1, 0)));
          l = e.display.shift || a.extend
            ? extendRange(a, l, p.anchor, p.head)
            : p;
        } else l = extendRange(a, l, n);
        i
          ? -1 == s
              ? ((s = u.length), setSelection(
                  a,
                  normalizeSelection(u.concat([l]), s),
                  { scroll: !1, origin: '*mouse' }
                ))
              : u.length > 1 && u[s].empty() && 'single' == r && !t.shiftKey
                  ? (setSelection(
                      a,
                      normalizeSelection(
                        u.slice(0, s).concat(u.slice(s + 1)),
                        0
                      ),
                      { scroll: !1, origin: '*mouse' }
                    ), (c = a.sel))
                  : replaceOneSelection(a, s, l, H)
          : ((s = 0), setSelection(a, new fe([l], 0), H), (c = a.sel));
        var f = n,
      ...
      function gutterEvent(e, t, n, r) {
        ...
        if (o > l.bottom || !hasHandler(e, n)) return e_defaultPrevented(t);
      ...
      function registerEventHandlers(e) {
        ...
        var t = e.display;
        G(t.scroller, 'mousedown', operation(e, onMouseDown)), a && l < 11
          ? G(
              t.scroller,
              'dblclick',
        ...
        G(t.scroller, 'touchstart', function(i) {
          ...
          t.scroller.clientHeight &&
            (setScrollTop(e, t.scroller.scrollTop), setScrollLeft(
              e,
              t.scroller.scrollLeft,
              !0
            ), signal(e, 'scroll', e));
      ...
      function indentLine(e, t, n, r) {
        ...
        var a = e.options.tabSize,
          l = getLine(o, t),
          s = countColumn(l.text, null, a);
        l.stateAfter && (l.stateAfter = null);
        var c, u = l.text.match(/^\s*/)[0];
        if (r || /\S/.test(l.text)) {
          if (
            'smart' == n &&
            ((c = o.mode.indent(i, l.text.slice(u.length), l.text)) == N ||
              c > 150)
          ) {
            if (!r) return;
            n = 'prev';
      ...
      function findPosH(e, t, n, r, i) {
        function findNextLine() {
          ...
          return (
            ...
            ((t = new Pos(r, t.ch, t.sticky)), (l = getLine(e, r)))
          );
        }
        function moveOnce(r) {
          var o;
          if (
            null ==
            (o = i ? moveVisually(e.cm, l, t, n) : moveLogically(l, t, n))
          ) {
            if (r || !findNextLine()) return !1;
            t = endOfLine(i, e.cm, l, t.line, n);
          } else t = o;
          return !0;
        }
        var o = t, a = n, l = getLine(e, t.line);
        if ('char' == r) moveOnce();
      ...
      function findPosV(e, t, n, r) {
        ...
        if ('page' == r) {
          var l = Math.min(
            ...
            s = Math.max(l - 0.5 * textHeight(e.display), 3);
      ...
      function domTextBetween(e, t, n, r, i) {
        ...
        function walk(t) {
          if (1 == t.nodeType) {
            ...
            var o, s = t.getAttribute('cm-marker');
            if (s) {
              var c = e.findMarks(
                Pos(r, 0),
                Pos(i + 1, 0),
              ...
              return void (c.length &&
                (o = c[0].find()) &&
                addText(getBetween(e.doc, o.from, o.to).join(l)));
            }
        ...
        for (
          var o = '', a = !1, l = e.doc.lineSeparator();
          walk(t), t != n;
      ...
      function locateNodeInLineView(e, t, n) {
          ...
          for (
            ...
            i++
              ...
              if (l == t || l == n) {
                ...
                return (r < 0 || l != t) && (d = o[a + (r ? 1 : 0)]), Pos(u, d);
              }
            }
        }
        ...
        var s = e.measure, c = s.maps, u = find(a, l, n);
        ...
        for (var f = l.previousSibling, h = n; f; f = f.previousSibling) {
      ...
      var O,
        ...
        V = (function() {
          ...
          return function(e, t) {
            ...
            for (var d = 0, p = l; d < s; ++d) {
              var f = c[d];
              'm' == f ? (c[d] = p) : (p = f);
            }
            for (var h = 0, g = l; h < s; ++h) {
              var m = c[h];
              '1' == m && 'r' == g
                ? (c[h] = 'n')
                : i.test(m) && ((g = m), 'r' == m && (c[h] = 'R'));
            }
            for (var v = 1, y = c[0]; v < s - 1; ++v) {
              var b = c[v];
              '+' == b && '1' == y && '1' == c[v + 1]
                ? (c[v] = '1')
                : ',' != b ||
      ...
      var ee,
        ...
        ae = 0,
        le = null;
      a ? (le = -0.53) : n ? (le = 15) : u ? (le = -0.7) : p && (le = -1 / 3);
      ...
      }), (se.prototype.enableZeroWidthBar = function(e, t) {
      ...
      }), (ce.prototype.setScrollLeft = function() {}), (ce.prototype.setScrollTop = function() {}), (ce.prototype.clear = function() {});
      var ue = { native: se, null: ce },
        de = 0,
        pe = function(e, t, n) {
          var r = e.display;
      ...
      (pe.prototype.signal = function(e, t) {
      ...
      (me.prototype.chunkSize = function() {
        ...
        for (var r = 0; r < this.children.length; ++r) {
          ...
          if (e < o) {
            ...
            if (
              (i.removeInner(e, a), (n.height -= l - i.height), o == a &&
          ...
          if (e <= a) {
            if ((o.insertInner(e, t, n), o.lines && o.lines.length > 50)) {
              for (
                ...
                var c = new ge(o.lines.slice(s, (s += 25)));
      ...
      (be.prototype.clear = function() {
        ...
        if (!this.explicitlyCleared) {
          ...
          for (var i = null, o = null, a = 0; a < this.lines.length; ++a) {
            var l = e.lines[a], s = getMarkedSpanFor(l.markedSpans, e);
            t && !e.collapsed
              ? regLineChange(t, lineNo(l), 'text')
              : t &&
                  (null != s.to && (o = lineNo(l)), null != s.from &&
                    (i = lineNo(l))), (l.markedSpans = removeMarkedSpan(
              l.markedSpans,
              s
            )), null == s.from &&
              e.collapsed &&
              !lineIsHidden(e.doc, l) &&
              t &&
              updateLineHeight(l, textHeight(t.display));
          }
        ...
        for (var r, i, o = 0; o < this.lines.length; ++o) {
          var a = n.lines[o], l = getMarkedSpanFor(a.markedSpans, n);
          if (null != l.from && ((r = Pos(t ? a : lineNo(a), l.from)), -1 == e))
            return r;
          if (null != l.to && ((i = Pos(t ? a : lineNo(a), l.to)), 1 == e))
            return i;
        }
        ...
        t &&
          ...
          runInOp(r, function() {
            ...
            if (
              ...
              var l = n.height;
              n.height = null;
              var s = widgetHeight(n) - l;
              s && updateLineHeight(i, i.height + s);
            }
      ...
      (we.prototype = createObj(me.prototype, {
        ...
        setValue: docMethodOp(function(e) {
          ...
          makeChange(
            ...
            !0
          ), setSelection(this, simpleSelection(t));
        }),
        ...
        replaceSelections: docMethodOp(function(e, t, n) {
          ...
          for (
            var s = t && 'end' != t && computeReplacedSel(this, i, t),
              c = i.length - 1;
            c >= 0;
            c--
          ) makeChange(r, i[c]);
      ...
      (Re.prototype.init = function(e) {
        ...
        var e = window.getSelection(),
          ...
          r = domToPos(this.cm, e.anchorNode, e.anchorOffset),
          i = domToPos(this.cm, e.focusNode, e.focusOffset);
        if (
          !r ||
          r.bad ||
          !i ||
          i.bad ||
          0 != cmp(minPos(r, i), t.from()) ||
          0 != cmp(maxPos(r, i), t.to())
        ) {
          var o = posToDOM(this.cm, t.from()), a = posToDOM(this.cm, t.to());
          if (!o && !a) return void e.removeAllRanges();
          var l = this.cm.display.view, s = e.rangeCount && e.getRangeAt(0);
          if (o) {
            if (!a) {
              var c = l[l.length - 1].measure,
                u = c.maps ? c.maps[c.maps.length - 1] : c.map;
              a = {
                node: u[u.length - 1],
                offset: u[u.length - 2] - u[u.length - 3]
              };
            }
          } else o = { node: l[0].measure.map[2], offset: 0 };
          var d;
          try {
            d = w(o.node, o.offset, a.offset, a.node);
          } catch (e) {}
          d &&
            (!n && this.cm.state.focused
              ? (e.collapse(o.node, o.offset), d.collapsed ||
                  (e.removeAllRanges(), e.addRange(d)))
              : (e.removeAllRanges(), e.addRange(d)), s && null == e.anchorNode
              ? e.addRange(s)
        ...
        r.line == t.viewFrom || 0 == (o = findViewIndex(e, r.line))
          ? ((a = lineNo(t.view[0].line)), (l = t.view[0].node))
          : ((a = lineNo(t.view[o].line)), (l =
              t.view[o - 1].node.nextSibling));
        var s, c, u = findViewIndex(e, i.line);
        if (
          (u == t.view.length - 1
            ? ((s = t.viewTo - 1), (c = t.lineDiv.lastChild))
            : ((s = lineNo(t.view[u + 1].line) - 1), (c =
                t.view[u + 1].node.previousSibling)), !l)
        )
          return !1;
        for (
          var d = e.doc.splitLines(domTextBetween(e, l, c, a, s)),
            p = getBetween(
              e.doc,
              Pos(a, 0),
              Pos(s, getLine(e.doc, s).text.length)
            );
          d.length > 1 && p.length > 1;

        )
          if (lst(d) == lst(p)) d.pop(), p.pop(), s--;
          else {
            if (d[0] != p[0]) break;
            d.shift(), p.shift(), a++;
          }
        ...
        (d[d.length - 1] = y
          ...
          .slice(f)
          .replace(/\u200b+$/, ''));
        var C = Pos(a, f), w = Pos(s, p.length ? lst(p).length - h : 0);
      ...
      (Ve.prototype.init = function(e) {
        ...
        if (!this.contextMenuPending) {
          ...
          if (r.somethingSelected()) {
            ...
            (this.textarea.value = s), r.state.focused && M(this.textarea), a &&
              l >= 9 &&
              (this.hasSelection = s);
          } else
            e ||
        ...
        if (o && !d) {
          ...
          var h;
          if (
            (s && (h = window.scrollY), r.input.focus(), s &&
              window.scrollTo(
                null,
                h
        ...
        (e.prototype = {
          ...
          indentSelection: methodOp(function(e) {
            for (
              ...
              if (o.empty())
                ...
                var a = o.from(), l = o.to(), s = Math.max(r, a.line);
          ...
          addWidget: function(e, t, n, r, i) {
            ...
            if (
              ...
              ('above' == r || e.bottom + t.offsetHeight > s) &&
                ...
                : e.bottom + t.offsetHeight <= s && (a = e.bottom), l +
                t.offsetWidth >
                c && (l = c - t.offsetWidth);
            }
            (t.style.top = a + 'px'), (t.style.left = t.style.right =
              ''), 'right' == i
              ? ((l = o.sizer.clientWidth - t.offsetWidth), (t.style.right =
                  '0px'))
              : ('left' == i
                  ? (l = 0)
                  : 'middle' == i &&
          ...
          findPosH: function(e, t, n, r) {
            ...
            t < 0 && ((o = -1), (t = -t));
            for (
              var a = clipPos(this.doc, e), l = 0;
              l < t && ((a = findPosH(i.doc, a, o, n, r)), !a.hitSide);
              ++l
            );
            return a;
          },
          ...
          findPosV: function(e, t, n, r) {
            var i = this, o = 1, a = r;
            t < 0 && ((o = -1), (t = -t));
            for (var l = clipPos(this.doc, e), s = 0; s < t; ++s) {
              var c = cursorCoords(i, l, 'div');
              if (
                (null == a ? (a = c.left) : (c.left = a), (l = findPosV(
                  i,
                  c,
                  o,
                  n
          ...
          moveV: methodOp(function(e, t) {
            ...
            if (
              (r.extendSelectionsBy(function(a) {
                ...
                var l = cursorCoords(n, a.head, 'div');
                null != a.goalColumn && (l.left = a.goalColumn), i.push(l.left);
                var s = findPosV(n, l, e, t);
                return 'page' == t &&
                  a == r.sel.primary() &&
                  addToScrollPos(
                    n,
                    null,
                    charCoords(n, s, 'div').top - l.top
                  ), s;
              }, W), i.length)
            )
          ...
          scrollTo: methodOp(function(e, t) {
            (null == e && null == t) ||
              resolveScrollToPos(
                this
              ), null != e && (this.curOp.scrollLeft = e), null != t && (this.curOp.scrollTop = t);
          }),
            ...
            if (
              (null == e
                ...
                : 'number' == typeof e
                    ...
                    : null == e.from && (e = { from: e, to: null }), e.to ||
                (e.to = e.from), (e.margin = t || 0), null != e.from.line)
            )
              resolveScrollToPos(this), (this.curOp.scrollToPos = e);
            else {
              var n = calculateScrollPos(this, {
          ...
          refresh: methodOp(function() {
            ...
            regChange(
              this
            ), (this.curOp.forceUpdate = !0), clearCaches(this), this.scrollTo(this.doc.scrollLeft, this.doc.scrollTop), updateGutterSpace(this), (null == e || Math.abs(e - textHeight(this.display)) > 0.5) && estimateLineHeights(this), signal(this, 'refresh', this);
          }),
          swapDoc: methodOp(function(e) {
            var t = this.doc;
            return (t.cm = null), attachDoc(this, e), clearCaches(this), this.display.input.reset(), this.scrollTo(e.scrollLeft, e.scrollTop), (this.curOp.forceScroll = !0), signalLater(this, 'swapDoc', this, t), t;
          }),
      ...
      e.defineMode('javascript', function(t, n) {
        ...
        function findFatArrow(e, t) {
          ...
          if (!(n < 0)) {
            ...
            for (var i = 0, o = !1, a = n - 1; a >= 0; --a) {
              var l = e.string.charAt(a), s = h.indexOf(l);
              if (s >= 0 && s < 3) {
                if (!i) {
                  ++a;
                  break;
        ...
        function parseJS(e, t, n, r, i) {
          ...
          for (
            ...
            if ((o.length ? o.pop() : s ? expression : statement)(n, r)) {
        ...
        function typeexpr(e) {
          return 'variable' == e
            ...
            : 'string' == e || 'number' == e || 'atom' == e
                ? cont(afterType)
                : '{' == e
                    ? cont(pushlex('}'), commasep(typeprop, '}', ',;'), poplex)
                    : '(' == e
        ...
        function typeprop(e, t) {
          return 'variable' == e || 'keyword' == m.style
            ...
            : '?' == t ? cont(typeprop) : ':' == e ? cont(typeexpr) : void 0;
        }
        function typearg(e) {
          return 'variable' == e
            ? cont(typearg)
        ...
        function afterType(e, t) {
          return '<' == t
            ...
            : '|' == t || '.' == e
                ? cont(typeexpr)
                : '[' == e ? cont(expect(']'), afterType) : void 0;
        }
        function vardef() {
        ...
        function classBody(e, t) {
          return 'variable' == e || 'keyword' == m.style
            ...
            : '[' == e
                ...
                : '*' == t
                    ? ((m.marked = 'keyword'), cont(classBody))
                    : ';' == e ? cont(classBody) : '}' == e ? cont() : void 0;
        }
        ...
        function(t, n) {
          ...
          function xmlToken(n, o, a) {
            ...
            if ('{' == n.peek()) {
              ...
              var l = flatXMLIndent(a.state), s = a.state.context;
              if (s && n.match(/^[^>]*>\s*$/, !1)) {
                for (; s.prev && !s.startOfLine; )
                  s = s.prev;
                s.startOfLine
                  ? (l -= t.indentUnit)
                  : a.prev.state.lexical && (l = a.prev.state.lexical.indented);
              } else 1 == a.depth && (l += t.indentUnit);
          ...
          function jsToken(t, n, o) {
            ...
            if (!a && null != o.depth) {
              ...
              '{' == l
                ? o.depth++
                : '}' == l && 0 == --o.depth && (n.context = n.context.prev);
            }
            return a;
          }
          var r = e.getMode(t, {
  ...
  811: function(e, t, n) {
    !(function(e) {
      ...
      e.defineMode('xml', function(r, i) {
        ...
        var o = r.indentUnit, a = {}, l = i.htmlMode ? t : n;
        ...
        return (inText.isInText = !0), {
          ...
          indent: function(t, n, r) {
            ...
            if (l && l[1])
              ...
              for (; i; ) {
                var s = a.contextGrabbers[i.tagName];
    ...
    (function(t) {
      function debounce(e, t, r) {
        ...
        function leadingEdge(e) {
          return (u = e), (s = setTimeout(timerExpired, t)), d
            ? invokeFunc(e)
            : l;
        }
        ...
        function timerExpired() {
          ...
          s = setTimeout(timerExpired, remainingWait(e));
        }
        function trailingEdge(e) {
          return (s = void 0), f && i ? invokeFunc(e) : ((i = o = void 0), l);
        }
        function cancel() {
          void 0 !== s && clearTimeout(s), (u = 0), (i = c = o = s = void 0);
        }
        function flush() {
          return void 0 === s ? l : trailingEdge(v());
        }
        function debounced() {
          var e = v(), n = shouldInvoke(e);
          if (((i = arguments), (o = this), (c = e), n)) {
            if (void 0 === s) return leadingEdge(c);
            if (p) return (s = setTimeout(timerExpired, t)), invokeFunc(c);
          }
          return void 0 === s && (s = setTimeout(timerExpired, t)), l;
        }
        var i, o, a, l, s, c, u = 0, d = !1, p = !1, f = !0;
    ...
    var r = n(0),
      ...
      s = r.createClass({
        ...
        getCodeMirrorInstance: function getCodeMirrorInstance() {
          return this.props.codeMirrorInstance || n(808);
        },
        getInitialState: function getInitialState() {
          return { isFocused: !1 };
        },
        componentWillMount: function componentWillMount() {
          this.componentWillReceiveProps = l(this.componentWillReceiveProps, 0);
        },
  ...
  814: function(e, t, n) {
    (t = e.exports = n(286)(void 0)), t.push([
      e.i,
