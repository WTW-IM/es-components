...
export type OurDatePickerProps<T extends boolean | undefined = undefined> =
  Override<
    DatePickerProps,
    {
...
> = {
  [key in keyof OurDatePickerProps]:
    | PropTypes.Requireable<OurDatePickerProps<T>[key]>
    | PropTypes.Validator<OurDatePickerProps<T>[key]>;
};
...
const reactDatePickerPropTypes: ReactDatePickerPropTypes<boolean | undefined> =
  {
    ...
    calendarStartDay: PropTypes.any,
    ...
    selectsRange: PropTypes.oneOf([true, undefined]),
...
export type ReactDatePickerPropName<T extends boolean | undefined = undefined> =
  Extract<keyof OurDatePickerProps<T>, string>;
