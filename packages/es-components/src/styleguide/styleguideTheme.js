...
export function useStyleguideTheme() {
  const isViaTheme = useSyncExternalStore(themeStore.subscribe, themeStore.getState);
...
export function ThemeSwitch() {
  ...
  return (
    <>
      <Switch offText="WTW" onText="Via" label="Theme" checked={isViaTheme} onChange={onChange} />
